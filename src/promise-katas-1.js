...
const returnString = async () => "string"
...
const returnList = async () => ["eggs", "apples", "milk", "bread"]
...
const internalServerError = () => Promise.reject({ error: 500 })
...
const happySad = (x) =>
  x > 1 ? Promise.resolve("happy") : Promise.reject("sad")
...
const amIYourFather = (name) =>
  name === "Luke"
    ? Promise.resolve("Yes. Luke, I am your father.")
    : Promise.reject("Not your dad.")
...
const myNameIs = () => Promise.resolve((name) => `My name is ${name}`)
